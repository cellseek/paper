...
\begin{figure}[h!]
  \centering
  \input{../figures/cellpose_sam_architecture_tikz}
...
\begin{figure}[h!]
  \centering
  \input{../figures/flow_field_visualization_tikz}
...
\begin{figure}[h!]
  \centering
  \input{../figures/memory_architecture_comparison_tikz}
...
\begin{figure}[h!]
  \centering
  \input{../figures/temporal_tracking_timeline_tikz}
